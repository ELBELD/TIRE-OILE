        ...
        private void btnAdditem_Click(object sender, EventArgs e)
        {
            try
            {
                if(comboName.Text!="" && comboCompany.Text!="" && txtCalibre.Text!="" && txtPrice.Text!=""&& txtCost.Text!="")
                {
                    ...
                    SqlCommand cmd = con.CreateCommand();
                    cmd.CommandType = CommandType.Text;
                    cmd.CommandText = "insert into product values(N'" + comboName.Text + "','" + comboCompany.Text + "','" + txtCalibre.Text + "','" + txtQuantity.Text + "','" + txtCost.Text + "','" + txtPrice.Text + "',N'" + txtNote.Text + "')";
                    cmd.ExecuteNonQuery();
                    con.Close();
                    LoadData();
                ...
                {
                    MessageBox.Show("الرجاء إدخال كافة المعلومات !!");
                }
        ...
        private void btnUpdateItem_Click(object sender, EventArgs e)
        {
            try
            {
                if (txtpid.Text != "")
                {
                    ...
                    SqlCommand cmd = con.CreateCommand();
                    cmd.CommandType = CommandType.Text;
                    cmd.CommandText = "update product set product=N'" + comboName.Text + "',company='" + comboCompany.Text + "',calibre='" + txtCalibre.Text + "',quantity='" + txtQuantity.Text + "',cost='" + txtCost.Text + "',price='" + txtPrice.Text + "',note=N'" + txtNote.Text + "' where pid='" + txtpid.Text + "'";
                    cmd.ExecuteNonQuery();
                    con.Close();
                    LoadData();
                ...
                {
                    MessageBox.Show("الرجاء الضغط على السطر للتعديل ");
                }
      ...
      (e.KeyChar != '.'))
        ...
        private void btnDelteItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("الرجاء الضغط على السطر للإلغاء ");
                }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("الرجاء الضغط على السطر مرتين اولاً ");
                }
            }
